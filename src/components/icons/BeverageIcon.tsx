...
const weights = new Map<IconWeight, React.ReactElement>([
  ...
  [
    ...
    <>
      {/* Filled glass */}
      <Path d="M200 72h-40V32.94l18.24-6.08a8 8 0 1 0-5.07-15.17L145.07 21a8 8 0 0 0-5.07 7.52V72H56a8 8 0 0 0-8 8 8 8 0 0 0 .47 2.67l16 128A24 24 0 0 0 88.28 232h79.44a24 24 0 0 0 23.81-21.33l16-128A8 8 0 0 0 208 80a8 8 0 0 0-8-8Zm-96 92a20 20 0 1 1 20-20 20 20 0 0 1-20 20Z" />
    </>,
  ],
]);
