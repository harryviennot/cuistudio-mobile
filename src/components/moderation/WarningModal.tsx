...
export const WarningModal = forwardRef<BottomSheetModal, WarningModalProps>(function WarningModal(
  { warning, onAcknowledge, isLoading = false },
  ref
) {
        ...
        <View className="px-6 pt-8">
          ...
          <View className="gap-4">
            <ActionButton
              ...
              size="default"
            />
            <Text className="text-center text-xs text-stone-400">{t("warnings.info")}</Text>
          </View>
        </View>
      </BottomSheetView>
    </BottomSheetModal>
